...
down_revision: Union[str, None] = '25dffe600017'
...
def downgrade() -> None:
    ...
    op.create_foreign_key('produced_item_item_id_fkey', 'produced_item', 'item', ['id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
    ...
    op.create_foreign_key('process_input_item_id_fkey', 'process_input', 'item', ['item_id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
    ...
    op.create_foreign_key('bought_item_item_id_fkey', 'bought_item', 'item', ['id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
    op.create_foreign_key('fk_bought_item_item', 'bought_item', 'item', ['id'], ['id'], ondelete='CASCADE')
    op.create_table('_demand_forecast',
