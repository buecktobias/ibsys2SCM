...
from material.calc.primary_demand.optimization_model.primary_production_solution_data import \
    ProductionSolutionData
from material.calc.primary_demand.optimization_model.production_planning_attributes import \
    ProductionPlanningAttributes
# noinspection PyUnresolvedReferences
from material.db.models.item import Item
from material.db.models.models import *
from material.db.models.mixins.periodic_item_quantity import PeriodicItemQuantityBuilder
...
def demand_data():
    return (
        ...
        .add_product(Item(2), [150, 50, 50, 50])
        .add_product(Item(3), [150, 100, 50, 50])
        .build()
    )
